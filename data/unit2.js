  ...
  lessons: [
    ...
    // ══════════════════════════════════════════════════════════════
    {
      ...
      steps: [
        ...
        `독해할 때 is/was/are/were 다음에<br>-ing로 끝나는 단어가 보이면<br>그 두 개를 묶어서 진행형 동사로 읽으세요.<br><br><div class="step-sentence">The children <mark class="v">were playing</mark> <span class="tok-mod">in the park.</span></div><br>were playing = 놀고 있었다 → 1형식<br>"in the park"는 전치사구 수식어`,

        `<strong>완료형</strong> — 과거부터 지금까지 이어진<br><br><strong>have/has + 과거분사(p.p.)</strong><br><br><div class="step-sentence"><mark class="s">그녀는</mark> <mark class="v">has written</mark> <mark class="o">소설을</mark>.</div>→ 써왔다, 써버렸다<br><br><div class="step-sentence"><mark class="s">그는</mark> <mark class="v">has lived</mark> <span class="tok-mod">여기서 10년간</span>.</div>→ 10년간 살아왔다 (지금도 살고 있음)`,
    ...
    // ══════════════════════════════════════════════════════════════
    {
      ...
      steps: [
        ...
        `<strong>can</strong> — 세 가지 얼굴<br><br>① <em>능력</em> — 할 수 있다<br><div class="step-sentence">She <mark class="v">can speak</mark> <mark class="o">four languages</mark>.</div>그녀는 네 개 언어를 말할 수 있다.<br><br>② <em>가능성</em> — 일어날 수 있다<br><div class="step-sentence">Stress <mark class="v">can cause</mark> <mark class="o">serious illness</mark>.</div>스트레스는 심각한 병을 일으킬 수 있다.<br><br>③ <em>허가</em> — 해도 된다<br><div class="step-sentence">You <mark class="v">can leave</mark> <span class="tok-mod">early today</span>.</div>오늘은 일찍 나가도 됩니다.`,

        `<strong>could</strong> — can의 과거이자 분신<br><br>① <em>과거의 능력</em><br><div class="step-sentence">She <mark class="v">could run</mark> <span class="tok-mod">very fast</span> <span class="tok-mod">when she was young</span>.</div>어렸을 때 매우 빠르게 달릴 수 있었다.<br><br>② <em>더 공손한 요청</em> (can보다 부드러움)<br><div class="step-sentence"><mark class="v">Could</mark> you <mark class="v">help</mark> me?</div>도와주실 수 있을까요?<br><br>③ <em>약한 가능성</em><br><div class="step-sentence">The rumor <mark class="v">could be</mark> <mark class="c">true</mark>.</div>그 소문이 사실일 수도 있다.`,

        `<strong>will</strong> — 의지와 미래<br><br>① <em>강한 의지</em> — 반드시 할 것이다<br><div class="step-sentence">I <mark class="v">will finish</mark> <mark class="o">this</mark> <span class="tok-mod">no matter what</span>.</div>무슨 일이 있어도 이것을 끝낼 것이다.<br><br>② <em>미래의 사실·예측</em><br><div class="step-sentence">The meeting <mark class="v">will start</mark> <span class="tok-mod">at 9 a.m.</span></div>회의는 오전 9시에 시작할 것이다.<br><br>③ <em>습관·특성</em> (종종 ~하곤 한다)<br><div class="step-sentence">Oil <mark class="v">will float</mark> <span class="tok-mod">on water</span>.</div>기름은 물 위에 뜨기 마련이다.`,

        `<strong>would</strong> — will의 과거이자 분신<br><br>① <em>과거의 습관</em> (used to와 비슷)<br><div class="step-sentence">She <mark class="v">would walk</mark> <span class="tok-mod">here every morning</span>.</div>그녀는 매일 아침 여기 걷곤 했다.<br><br>② <em>가정법</em> — 사실과 반대되는 상상<br><div class="step-sentence">If I <mark class="v">were</mark> you, I <mark class="v">would quit</mark>.</div>내가 너라면 그만둘 텐데.<br><br>③ <em>공손한 요청</em><br><div class="step-sentence"><mark class="v">Would</mark> you <mark class="v">mind</mark> <span class="tok-mod">closing the door</span>?</div>문 좀 닫아주시겠어요?`,
    ...
    // ══════════════════════════════════════════════════════════════
    {
      ...
      steps: [
        ...
        `<div class="step-sentence"><mark class="s">사과는</mark> <mark class="v">먹혀진다</mark> <span class="tok-mod">나에 의해</span>.</div><br>이번에는 사과가 주어입니다.<br>사과가 행동을 당하고 있어요.<br><br>이것을 <strong>수동태</strong>라고 합니다.<br>당하는 입장에서 문장을 쓴 것입니다.`,
        ...
        `예문으로 볼게요.<br><br><div class="step-sentence">능동: <mark class="s">Hemingway</mark> <mark class="v">wrote</mark> <mark class="o">this novel.</mark></div><div class="step-sentence">수동: <mark class="s">This novel</mark> <mark class="v">was written</mark> <span class="tok-mod">by Hemingway.</span></div><br>능동의 목적어 → 수동의 주어<br>능동의 주어 → by + 행위자 (생략 가능)`,

        `by + 행위자는 생략되는 경우가 많습니다.<br><br>행위자를 모르거나, 밝히지 않아도 될 때.<br><br><div class="step-sentence">The bridge <mark class="v">was built</mark> <span class="tok-mod">in 1920.</span></div>누가 지었는지 중요하지 않아요.<br><br><div class="step-sentence">The results <mark class="v">were announced</mark> <span class="tok-mod">at the conference.</span></div>누가 발표했는지보다 발표된 사실이 중요합니다.`,

        `수동태가 많이 쓰이는 글: 뉴스·논문·보고서<br><br>독해에서 수동태가 자주 나오는 이유:<br>객관성을 강조하고 싶을 때,<br>행위자보다 대상이 더 중요할 때 씁니다.<br><br><div class="step-sentence">The vaccine <mark class="v">was developed</mark> <span class="tok-mod">in record time.</span></div>누가 개발했는지보다 개발되었다는 사실이 중요.`,

        `조동사 + 수동태:<br><br><strong>조동사 + be + p.p.</strong><br><br><div class="step-sentence">This problem <mark class="v">can be solved</mark>.</div>이 문제는 해결될 수 있다.<br><br><div class="step-sentence">The report <mark class="v">must be submitted</mark> <span class="tok-mod">by Friday.</span></div>보고서는 금요일까지 제출되어야 한다.`,
    ...
    // ══════════════════════════════════════════════════════════════
    {
      ...
      steps: [
        ...
        `실전 문장 1.<br><br><div class="step-sentence">The discovery <span class="tok-mod">[that shocked the world]</span> <mark class="v">was made</mark> <span class="tok-mod">[by a young researcher]</span> <span class="tok-mod">[in a small lab].</span></div><br>관계사절 + 전치사구 2개 제거<br>수동태 동사: was made<br>뼈대: The discovery was made. — 1형식(수동)`,

        `실전 문장 2.<br><br><div class="step-sentence">Scientists <mark class="v">have been studying</mark> this phenomenon <span class="tok-mod">for decades</span>, but they <mark class="v">have not yet found</mark> a clear explanation.</div><br>have been studying = 완료 + 진행형 (연구해오고 있다)<br>have not yet found = 완료형 부정 (아직 찾지 못했다)<br>두 절이 but으로 연결된 구조입니다.`,

        `실전 문장 3.<br><br><div class="step-sentence">The policy <span class="tok-mod">[that was introduced last year]</span> <mark class="v">could significantly reduce</mark> <mark class="o">carbon emissions</mark> <span class="tok-mod">[in the coming decades].</span></div><br>관계사절 + 전치사구 제거<br>조동사형 동사: could reduce<br>뼈대: The policy could reduce carbon emissions. — 3형식`,
