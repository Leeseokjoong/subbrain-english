...
const UNIT6 = {
  ...
  lessons: [
    ...
    // ══════════════════════════════════════════════════════════════
    {
      ...
      steps: [
        `강조구문 — 문장의 특정 부분을 "바로 이것!"이라고 강조하는 방법.<br><br>일반 문장: Tom broke the window yesterday.<br><br>주어 강조: <strong>It was Tom that</strong> broke the window yesterday.<br>→ 창문을 깬 건 바로 톰이었다.<br><br>목적어 강조: <strong>It was the window that</strong> Tom broke yesterday.<br>→ 톰이 깬 건 바로 창문이었다.<br><br>부사 강조: <strong>It was yesterday that</strong> Tom broke the window.<br>→ 톰이 창문을 깬 건 바로 어제였다.`,

        `It is[was] ~ that 강조구문 — 해석법.<br><br>"It is/was + 강조할 내용 + that + 나머지"<br><br><div class="step-sentence"><strong>It was the discovery of penicillin that</strong> revolutionized modern medicine.</div>→ 현대 의학을 혁신한 것은 바로 페니실린의 발견이었다.<br><br>강조구문인지 확인하는 방법:<br>It is[was] ~ that을 제거해도 문장이 완전하면 → 강조구문<br><br>The discovery of penicillin revolutionized modern medicine. ← 완전한 문장 ✓<br><br>cf. It is ~ that (동격) → 제거하면 불완전 → 강조구문 아님`,

        `do/does/did 강조 — 동사를 강조할 때.<br><br>현재: do/does + 동사원형<br>과거: did + 동사원형<br><br>I <strong>do believe</strong> this approach works.<br>→ 나는 정말로 이 접근법이 효과 있다고 믿는다.<br><br>She <strong>does care</strong> about the environment.<br>→ 그녀는 정말로 환경을 신경 쓴다.<br><br>The experiment <strong>did produce</strong> unexpected results.<br>→ 실험은 정말로 예상치 못한 결과를 낳았다.<br><br>do 강조는 "의심을 반박"하거나 "사실임을 확인"할 때 씁니다.`,
    ...
    // ══════════════════════════════════════════════════════════════
    {
      ...
      steps: [
        `병렬구조(Parallelism) — 접속사로 연결되는 것들은<br>문법적으로 <strong>같은 형태</strong>여야 합니다.<br><br>명사 and 명사 ✓<br>to부정사 and to부정사 ✓<br>-ing and -ing ✓<br>절 and 절 ✓<br><br>to부정사 and -ing ✗<br>명사 and 절 ✗<br><br>The key is <strong>not winning but learning</strong>. (✓)<br>The key is <strong>not to win but learning</strong>. (✗)`,
    ...
    // ══════════════════════════════════════════════════════════════
    {
      ...
      steps: [
        `UNIT 6 정리 — 영어의 마지막 장치들.<br><br><strong>비교구문</strong> — as~as / 비교급+than / the 비교급 the 비교급<br><strong>강조구문</strong> — It is~that / do강조 / What~is<br><strong>도치</strong> — 부정어도치 / 조건절도치 / so/neither도치<br><strong>병렬구조</strong> — 접속사 앞뒤 형태 일치<br><br>이 네 가지는 "의미의 장치"가 아니라<br>"강조와 구조의 장치"입니다.<br>의미는 같아도 무게와 느낌이 달라집니다.`,
