  ...
  lessons: [
    ...
    // ══════════════════════════════════════════════════════════════
    {
      ...
      steps: [
        ...
        `실전 — 복합 문장 분해 연습.<br><br><div class="step-sentence"><span class="tok-mod">[Although many believe that technology causes isolation]</span>, studies indicate <mark class="o">[that it can also foster connection]</mark> <span class="tok-mod">[when used mindfully]</span>.</div><br>분해:<br>① Although절 (양보 부사절) → 수식어<br>② studies indicate = 주절 뼈대<br>③ that it can also foster connection = 목적어 명사절<br>④ when used mindfully = 시간 부사절 → 수식어<br><br>뼈대: studies indicate [that it can foster connection]., studies indicate <mark class="o">[that it can also foster connection]</mark> <span class="tok-mod">[when used mindfully]</span>.</div><br>Breakdown:<br>① Although clause (concessive adverbial clause) → modifier<br>② studies indicate = main clause skeleton<br>③ that it can also foster connection = object noun clause<br>④ when used mindfully = time adverbial clause → modifier<br><br>Skeleton: studies indicate [that it can foster connection].</span>`,
