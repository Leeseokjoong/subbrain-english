  ...
  lessons: [
    ...
    // ══════════════════════════════════════════════════════════════
    {
      ...
      steps: [
        ...
        `그런데 영어는 이 자리 이동이 특히 자유롭습니다.<br><br><strong>water</strong> — 물(명사)<br>동사 자리에 가면 → "물을 주다"<br><br><strong>place</strong> — 장소(명사)<br>동사 자리에 가면 → "두다, 놓다"<br><br><div class="step-sentence"><mark class="s">She</mark> <mark class="v">watered</mark> <mark class="o">the plants</mark>.</div>그녀는 물을 주었다 식물에.<br><br><div class="step-sentence"><mark class="s">He</mark> <mark class="v">placed</mark> <mark class="o">the book</mark> <span class="tok-mod">on the table</span>.</div>그는 두었다 책을 테이블 위에.<br><br>한국어는 품사가 비교적 고정되어 있습니다.<br>하지만 영어에서는 명사가 동사 자리에 앉는 순간<br>동사의 역할을 합니다.<br>자리가 그만큼 강력합니다..</div><br>Korean parts of speech are relatively fixed.<br>But in English, the moment a noun sits in the verb slot,<br>it functions as a verb.<br>That is how powerful the slot is.</span>`,
    ...
    // ══════════════════════════════════════════════════════════════
    {
      ...
      steps: [
        ...
        `물론 수식어를 더할 수 있어요.<br>수식어는 양념이니까요.<br><br><div class="step-sentence"><mark class="s">나는</mark> <mark class="v">달린다</mark> <span class="tok-mod">빠르게</span>.</div><div class="step-sentence"><mark class="s">비가</mark> <mark class="v">온다</mark> <span class="tok-mod">세차게</span> <span class="tok-mod">밖에서</span>.</div><br>수식어가 아무리 붙어도<br>뼈대는 [는] + [다] 입니다..</div><div class="step-sentence"><mark class="s">비가</mark> <mark class="v">온다</mark> <span class="tok-mod">세차게</span> <span class="tok-mod">밖에서</span>.</div><br>No matter how many modifiers you add,<br>the skeleton is still [subject] + [verb].</span>`,

        `독해할 때 활용법.<br><br>긴 문장을 보면 먼저 동사를 찾고,<br>앞에서 주어를 확인하세요.<br>나머지는 수식어입니다.<br><br><div class="step-sentence"><span class="tok-mod">이른 아침에</span> <mark class="s">공원의 새들이</mark> <mark class="v">노래한다</mark> <span class="tok-mod">나뭇가지 위에서</span>.</div><br>뼈대: 새들이 노래한다. <mark class="s">공원의 새들이</mark> <mark class="v">노래한다</mark> <span class="tok-mod">나뭇가지 위에서</span>.</div><br>Skeleton: The birds sing.</span>`,
    ...
    // ══════════════════════════════════════════════════════════════
    {
      ...
      steps: [
        ...
        `수식어가 붙어도 뼈대는 변하지 않아요.<br><br><div class="step-sentence"><mark class="s">그녀는</mark> <mark class="v">보인다</mark> <mark class="c">행복하게</mark> <span class="tok-mod">오늘따라</span>.</div><br>뼈대: 그녀는 보인다 행복하게.<br>"오늘따라"는 양념(수식어) → 제거 대상.</div><br>Skeleton: She looks happy.<br>"오늘따라" is seasoning (modifier) → to be removed.</span>`,
    ...
    // ══════════════════════════════════════════════════════════════
    {
      ...
      steps: [
        ...
        `수식어가 붙어도 뼈대는 같아요.<br><br><div class="step-sentence"><mark class="s">나는</mark> <mark class="v">먹는다</mark> <span class="tok-mod">항상</span> <span class="tok-mod">빨간</span> <mark class="o">사과를</mark> <span class="tok-mod">빠르게</span> <span class="tok-mod">아침에</span>.</div><br>수식어: 항상 / 빨간 / 빠르게 / 아침에<br>뼈대: 나는 먹는다 사과를. <span class="tok-mod">빨간</span> <mark class="o">사과를</mark> <span class="tok-mod">빠르게</span> <span class="tok-mod">아침에</span>.</div><br>Modifiers: always / red / quickly / in the morning<br>Skeleton: I eat an apple.</span>`,

        `독해할 때 활용.<br><br><div class="step-sentence"><span class="tok-mod">오랫동안</span> <mark class="s">그는</mark> <mark class="v">써왔다</mark> <span class="tok-mod">자신의 경험을 담은</span> <mark class="o">편지를</mark> <span class="tok-mod">매일 밤</span>.</div><br>뼈대: 그는 써왔다 편지를. (3형식)<br>나머지는 전부 수식어입니다. <mark class="s">그는</mark> <mark class="v">써왔다</mark> <span class="tok-mod">자신의 경험을 담은</span> <mark class="o">편지를</mark> <span class="tok-mod">매일 밤</span>.</div><br>Skeleton: He has written letters. (Pattern 3)<br>Everything else is a modifier.</span>`,
    ...
    // ══════════════════════════════════════════════════════════════
    {
      ...
      steps: [
        ...
        `관계사절은 이렇게 생겼어요.<br><br><div class="step-sentence">남자 <span class="tok-mod">[who runs every day]</span></div>매일 달리는 남자 → "who runs every day"가 "남자"를 설명<br><br><div class="step-sentence">책 <span class="tok-mod">[that I bought]</span></div>내가 산 책 → "that I bought"가 "책"을 설명</div>The man who runs every day → "who runs every day" describes "남자"<br><br><div class="step-sentence">책 <span class="tok-mod">[that I bought]</span></div>The book that I bought → "that I bought" describes "책"</span>`,

        `관계사절 찾는 법.<br><br><strong>명사 바로 뒤</strong>에 who / which / that이<br>보이면 거기서 관계사절이 시작됩니다.<br><br>끝나는 지점은 쉼표나 다음 핵심 성분이<br>시작되는 곳입니다.`,

        `독해 전략 — 관계사절 묶기.<br><br><div class="step-sentence">The scientist <span class="tok-mod">[who discovered the cure]</span> won the prize.</div><br>scientist = 주어, won = 동사, prize = 목적어<br>"who discovered the cure"는 [ ]로 묶어 제거<br>뼈대: The scientist won the prize. won the prize.</div><br>scientist = subject, won = verb, prize = object<br>Bracket and remove "who discovered the cure"<br>Skeleton: The scientist won the prize.</span>`,

        `전치사구와 관계사절이 함께 나올 때.<br><br><div class="step-sentence">The boy <span class="tok-mod">[who lives next door]</span> runs <span class="tok-mod">[every morning]</span> <span class="tok-mod">[in the park]</span>.</div><br>관계사절 [ ] + 전치사구 [ ] + [ ] 모두 제거:<br>뼈대: The boy runs. — 1형식<br><br>겁먹지 마세요. 하나씩 걷어내면 됩니다. runs <span class="tok-mod">[every morning]</span> <span class="tok-mod">[in the park]</span>.</div><br>Remove the relative clause [ ] + prepositional phrases [ ] + [ ]:<br>Skeleton: The boy runs. — Pattern 1<br><br>Don't be intimidated. Just remove them one by one.</span>`,

        `관계사절이 목적어에 붙을 때.<br><br><div class="step-sentence"><mark class="s">나는</mark> <mark class="v">읽었다</mark> <mark class="o">책 <span class="tok-mod">[that you recommended]</span>을.</mark></div><br>핵심 목적어는 "책"이고<br>"that you recommended"는 그 책을 설명하는 장신구.<br>뼈대: 나는 읽었다 책을. — 3형식을.</mark></div><br>The core object is "책" (book),<br>and "that you recommended" is the accessory describing that book.<br>Skeleton: I read the book. — Pattern 3</span>`,
    ...
    // ══════════════════════════════════════════════════════════════
    {
      ...
      steps: [
        ...
        `실제로 해볼게요.<br><br><div class="step-sentence">The company <span class="tok-mod">[that she founded]</span> <span class="tok-mod">[in 2010]</span> became the biggest firm <span class="tok-mod">[in the country]</span>.</div><br>관계사절 [ ] + 전치사구 [ ][ ] 묶기<br>뼈대: The company became the biggest firm.<br>→ 2형식 (회사 = 가장 큰 회사) <span class="tok-mod">[in 2010]</span> became the biggest firm <span class="tok-mod">[in the country]</span>.</div><br>Bracket relative clause [ ] + prepositional phrases [ ][ ]<br>Skeleton: The company became the biggest firm.<br>→ Pattern 2 (company = the biggest firm)</span>`,

        `하나 더 해볼게요.<br><br><div class="step-sentence">The scientist <span class="tok-mod">[who won the prize]</span> announced the results <span class="tok-mod">[of her research]</span> <span class="tok-mod">[at the conference]</span>.</div><br>관계사절 + 전치사구 2개 제거<br>뼈대: The scientist announced the results.<br>→ 3형식 announced the results <span class="tok-mod">[of her research]</span> <span class="tok-mod">[at the conference]</span>.</div><br>Remove relative clause + 2 prepositional phrases<br>Skeleton: The scientist announced the results.<br>→ Pattern 3</span>`,

        `수식어가 많을수록 뼈대가 잘 보여야 합니다.<br><br><div class="step-sentence">Despite the rain, the athlete <span class="tok-mod">[who had trained for years]</span> finished the race <span class="tok-mod">[in record time]</span>.</div><br>Despite the rain = 전치사구<br>who had trained for years = 관계사절<br>in record time = 전치사구<br>뼈대: the athlete finished the race. — 3형식 finished the race <span class="tok-mod">[in record time]</span>.</div><br>Despite the rain = prepositional phrase<br>who had trained for years = relative clause<br>in record time = prepositional phrase<br>Skeleton: the athlete finished the race. — Pattern 3</span>`,
